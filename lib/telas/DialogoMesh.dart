...
class DialogoMesh extends StatefulWidget {
  const DialogoMesh({Key? key}) : super(key: key);

  @override
  State<DialogoMesh> createState() => _DialogoMeshState();
}

class _DialogoMeshState extends State<DialogoMesh> {
  ...
  Widget build(BuildContext context) {
    controller.mesh_limpar_dialogo();
    controller.mesh_seleciona_tipo("Instalação Padrão");
    Mesh listas = Mesh();
                                              ...
                                              child: Align(
                                                ...
                                                child: DropdownButtonFormField<String>(
                                                    ...
                                                    onChanged: (String? novoValor) {
                                                      controller.mesh_seleciona_tipo(novoValor);
                                                    },
                                                    ...
                                                    itemHeight: null,
                                                    value: controller.mesh_tipo_selecionado_dropdown.value,
                                      ...
                                      Container(
                                          ...
                                          child: Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                IconButton(
                                                    onPressed: (){ controller.mesh_bt_rem_qtd(); },
                                                    iconSize: 35,
                                                ...
                                                Text(
                                                  controller.mesh_qtd_adicionar.toString(),
                                                  style: res.texto_bold_azul_claro_16,
                                                ),
                                                IconButton(
                                                    onPressed: (){ controller.mesh_bt_add_qtd(); },
                                                    iconSize: 35,
                                                    splashColor: Colors.transparent,
                                                    hoverColor: Colors.transparent,
                                                    highlightColor: Colors.transparent,
  ...
  salvar_mesh(){
    if(controller.mesh_tipo_selecionado_dropdown == "" || controller.mesh_tipo_selecionado_dropdown.toString().isEmpty){
      Flushbar(
      ...
      novo.tipo = controller.mesh_tipo_selecionado_dropdown.toString();
      for(int i = 0; i < controller.mesh_qtd_adicionar.value; i++){
        controller.mesh_adicionar(novo);
      }
