...
class DialogoTvHD extends StatefulWidget {
  const DialogoTvHD({Key? key}) : super(key: key);

  @override
  State<DialogoTvHD> createState() => _DialogoTvHDState();
}

class _DialogoTvHDState extends State<DialogoTvHD> {
  ...
  Widget build(BuildContext context) {
    controller.tvhd_limpar_dialogo();
    TvHd listas = TvHd();
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                                              ...
                                              child: Align(
                                                ...
                                                child: DropdownButtonFormField<String>(
                                                    ...
                                                    onChanged: (String? novoValor) {
                                                      controller.tvhd_seleciona_plano(novoValor);
                                                    },
                                                    items: listas.planos_tv.map((String value) {
                                                    ...
                                                    itemHeight: null,
                                                    value: controller.tvhd_plano_selecionado_dropdown.value,
                          ...
                          Obx(() =>
                              Visibility(
                                visible: controller.tvhd_plano_selecionado_dropdown == "Ponto Adicional" ? true : false,
                                child: Padding(
                                  padding: EdgeInsets.fromLTRB(16,0,16,0),
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            ...
                                            Container(
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      IconButton(
                                                          onPressed: (){ controller.tvhd_bt_rem_qtd(); },
                                                          iconSize: 35,
                                                      ...
                                                      Text(
                                                        controller.tvhd_qtd_adicionar.toString(),
                                                        style: res.texto_bold_azul_claro_16,
                                                      ),
                                                      IconButton(
                                                          onPressed: (){ controller.tvhd_bt_add_qtd(); },
                                                          iconSize: 35,
                                                          splashColor: Colors.transparent,
                                                          hoverColor: Colors.transparent,
                                                          highlightColor: Colors.transparent,
  ...
  salvar_tvhd(){
    if(controller.tvhd_plano_selecionado_dropdown.value == ""){
      Flushbar(
      ...
      TvHd novo = TvHd();
      novo.plano = controller.tvhd_plano_selecionado_dropdown.value;
      novo.mensalidade = 0;
      ...
      if(controller.tvhd_plano_selecionado_dropdown.value == "Ponto Adicional"){
        for(int i = 0; i < controller.tvhd_qtd_adicionar.value; i++){
          controller.tvhd_adicionar(novo);
        }
      }
      else{
        controller.tvhd_adicionar(novo);
