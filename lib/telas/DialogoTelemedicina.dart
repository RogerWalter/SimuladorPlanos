...
class DialogoTelemedicina extends StatefulWidget {
  const DialogoTelemedicina({Key? key}) : super(key: key);

  @override
  State<DialogoTelemedicina> createState() => _DialogoTelemedicinaState();
}

class _DialogoTelemedicinaState extends State<DialogoTelemedicina> {
  Controller controller = Get.find();
  Telemedicina novo = Telemedicina();
  Res res = Res();

  @override
  Widget build(BuildContext context) {
    controller.telemed_limpar_dialogo();
    List<String> listas = [];
    Telemedicina busca = Telemedicina();
    if(controller.tipo_cliente == 0)//PF
      listas = busca.lista_plano_pf;
    else//PJ
      listas = busca.lista_plano_pj;
          ...
          if(layout_largura>1000 && layout_altura>500){
            return SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    width: (largura > 1300) ? largura/2.5 : largura/1.5,
                                              ...
                                              child: Align(
                                                ...
                                                child: DropdownButtonFormField<String>(
                                                    ...
                                                    onChanged: (String? novoValor) {
                                                      controller.telemed_seleciona_plano(novoValor);
                                                    },
                                                    ...
                                                    itemHeight: null,
                                                    value: controller.telemed_plano_selecionado_dropdown.value,
                                      ...
                                      Container(
                                          ...
                                          child: Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                IconButton(
                                                    onPressed: (){ controller.telemed_bt_rem_qtd(); },
                                                    iconSize: 35,
                                                ...
                                                Text(
                                                  controller.telemed_qtd_adicionar.toString(),
                                                  style: res.texto_bold_azul_claro_16,
                                                ),
                                                IconButton(
                                                    onPressed: (){ controller.telemed_bt_add_qtd(); },
                                                    iconSize: 35,
                                                    splashColor: Colors.transparent,
                                                    hoverColor: Colors.transparent,
                                                    highlightColor: Colors.transparent,
  ...
  salvar_telemedicina(){
    if(controller.tipo_cliente == 0){//PF
      if(controller.telemed_plano_selecionado_dropdown.value == ""){
        Flushbar(
        ...
        Telemedicina novo = Telemedicina();
        novo.plano = controller.telemed_plano_selecionado_dropdown.value;
        novo.valor_mensalidade = 0;
        ...
        for(int i = 0; i < controller.telemed_qtd_adicionar.value; i++){
          controller.telemed_adicionar(novo);
        }
